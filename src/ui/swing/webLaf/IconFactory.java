...
public class IconFactory {
    ...
    public static String CAMINHO_ICONES_PEQUENOS = "ui/resources/";
    public static String CAMINHO_ICONES_GRANDES = "ui/resources/";
    public static final String CAMINHO_IMAGENS = "ui/resources/";
    ...
    private static Image loadDefautWindowlIcon(){
        ...
        try
        {
            image = ImageIO.read(ClassLoader.getSystemClassLoader().getResourceAsStream(IconFactory.CAMINHO_ICONES_GRANDES + "/icon32.png"));
        }
    ...
    {
            CAMINHO_ICONES_PEQUENOS = "ui/resources/";
            CAMINHO_ICONES_GRANDES = "ui/resources/";
    ...
    private static Icon criarIconePadrao()
    {
        try
        {
            String path = getFilePath(CAMINHO_ICONES_PEQUENOS, "icon32.png");
    ...
    public static Icon createIcon(File arquivo)
    {
        ...
        {
            return createIcon(CAMINHO_ICONES_PEQUENOS, "icon32.png");
        }
    }
